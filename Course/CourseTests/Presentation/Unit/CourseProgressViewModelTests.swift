...
final class CourseProgressViewModelTests: XCTestCase {
    ...
    func testGetCourseProgressSuccess() async throws {
        ...
        interactor.getCourseProgressHandler = { _ in CourseProgressViewModelTests.mockCourseProgress }

        await viewModel.getCourseProgress(courseID: "test-course-id")

        XCTAssertEqual(interactor.getCourseProgressCallCount, 1)
    ...
    func testGetCourseProgressOfflineSuccess() async throws {
        ...
        interactor.getCourseProgressOfflineHandler = { _ in CourseProgressViewModelTests.mockCourseProgress }

        await viewModel.getCourseProgress(courseID: "test-course-id")

        XCTAssertEqual(interactor.getCourseProgressOfflineCallCount, 1)
        XCTAssertFalse(viewModel.isLoading)
        XCTAssertFalse(viewModel.showError)
        XCTAssertNotNil(viewModel.courseProgress)
    }
    ...
    func testGetCourseProgressUnknownError() async throws {
        ...
        connectivity.isInternetAvaliable = true
        interactor.getCourseProgressHandler = { _ in throw NSError(domain: "error", code: -1, userInfo: nil) }
    ...
    func testGetCourseProgressNoInternetError() async throws {
        ...
        connectivity.isInternetAvaliable = true
        interactor.getCourseProgressHandler = { _ in throw noInternetError }
    ...
    func testGetCourseProgressNoCacheError() async throws {
        ...
        connectivity.isInternetAvaliable = true
        interactor.getCourseProgressHandler = { _ in throw NoCachedDataError() }
    ...
    func testTrackProgressTabClicked() {
        ...
        XCTAssertEqual(analytics.courseOutlineProgressTabClickedCallCount, 1)
    }
