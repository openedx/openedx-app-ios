...
public enum ThemeAssets {
  ...
  public static let secondardButtonBorderColor = ColorAsset(name: "SecondardButtonBorderColor")
  public static let secondardButtonTextColor = ColorAsset(name: "SecondardButtonTextColor")
